import { CaseFsmEvent, CaseFsmState } from './fsm.types';

export const INITIAL_STATE: CaseFsmState = 'case_created';

export const TERMINAL_STATES: CaseFsmState[] = ['archived'];

export const FSM_TRANSITIONS: Record<CaseFsmState, Partial<Record<CaseFsmEvent, CaseFsmState>>> = {
  case_created: {

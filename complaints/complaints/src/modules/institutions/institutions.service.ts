...
export class InstitutionsService {
  ...
  async getInstitutionById(id: string): Promise<InstitutionRecord | null> {
    const result = await postgres.query<InstitutionRecord>(
      `
      select
        id,
  ...
  async updateInstitution(id: string, body: UpdateInstitutionBody): Promise<InstitutionRecord> {
